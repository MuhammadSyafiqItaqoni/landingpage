                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->image && Storage::disk('public')->exists($item->image))
                                    <img src="{{ asset('storage/' . $item->image) }}" alt="service" width="100" class="rounded">
                                @else
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="{{ route('service.destroy', $item->id) }}" method="POST">
                                            @csrf @method('DELETE')
                                            <button type="submit" class="dropdown-item" onclick="return confirm('Yakin hapus?')"><i class="bx bx-trash me-1"></i> Delete</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
